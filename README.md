...
This fork turns the official Nosana x ElizaOS starter into `Operator Desk`, a personal AI chief-of-staff agent for builders and traders. It is designed to turn saved context, watchlists, and task pressure into a ranked daily action board.
  ...
  "ops": [
    {
      ...
      "id": "eliza-agent",
      "args": {
        "image": "frederikbus/nosana-operator-desk:amd64",
        "ports": ["3000:3000"],
        "env": {
          "OPENAI_API_KEY": "nosana",
          "OPENAI_API_URL": "https://6vq2bcqphcansrs9b88ztxfs88oqy7etah2ugudytv2x.node.k8s.prd.nos.ci/v1",
